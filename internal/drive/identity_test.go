...
func TestRBACPermissionMatrix(t *testing.T) {
	tests := []struct {
		...
		{RoleOwner, []Permission{PermissionTenantRead, PermissionMembersRead, PermissionMembersManage, PermissionGroupsManage, PermissionAuditRead, PermissionFilesRead, PermissionFilesWrite, PermissionFilesDelete}},
		{RoleAdmin, []Permission{PermissionTenantRead, PermissionMembersRead, PermissionMembersManage, PermissionGroupsManage, PermissionAuditRead, PermissionFilesRead, PermissionFilesWrite, PermissionFilesDelete}},
